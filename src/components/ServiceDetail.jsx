      ...
      <div className="py-12 bg-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="mt-6">
            <button
              onClick={() => navigate("/")}
              className="rounded-full bg-sky-600 px-5 py-2 text-sm font-semibold text-white hover:bg-sky-700 transition"
            >
              Back to home
            </button>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid gap-8 md:grid-cols-12">
          ...
          <motion.div variants={item} className="md:col-span-8">
            {/* Hero: Image + Title */}
            <div className="mb-8">
              <div className="aspect-video w-full bg-slate-100 rounded-2xl overflow-hidden shadow-sm">
                <img
                  src={service.img}
                  alt={service.name}
            ...
            <div className="rounded-2xl border border-slate-100 shadow-sm mt-8">
              <div className="px-6 py-8">
                <h2 className="text-lg font-semibold text-slate-900">About this service</h2>
                <p className="mt-3 text-slate-600 leading-relaxed">
                  {service.long || service.description}
                </p>
                      ...
                      <div className="mt-3">
                        ...
                        <div className="mt-3 flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="text-xs rounded-full border border-slate-200 px-3 py-1"
                          >
                            Enquire
                          </button>
                        </div>
            ...
            <div className="sticky top-28 space-y-4">
              <div className="rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
                ...
                <div className="mt-6 flex gap-3">
                  <button
                    ...
                    className="flex-1 rounded-full bg-sky-600 px-4 py-2 text-sm font-semibold text-white hover:bg-sky-700 transition"
                  >
                    Contact us
                  </button>
                  <Link
                    to="/services"
                    className="inline-flex items-center justify-center rounded-full border border-slate-200 px-3 py-2 text-sm text-slate-700 hover:bg-slate-50"
                  >
                    All services
                  </Link>
                </div>
              ...
              <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 text-sm text-slate-600 shadow-sm">
                ...
                <ul className="space-y-2">
                  <li>
                    ...
                    {service.coverage || "India – remote & on-site"}
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    {service.compliance || "Local regulations"}
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm">
                ...
                <p className="mt-2 text-xs text-slate-600">
                  Tell us a bit about your requirement and we'll share a tailored plan.
                </p>
                <div className="mt-3">
                  <button
                    onClick={() =>
                    ...
                    className="w-full rounded-full bg-emerald-600 px-3 py-2 text-sm font-semibold text-white hover:bg-emerald-700 transition"
                  >
                    Get a tailored plan
                  </button>
                </div>
